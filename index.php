...
<a href="mailto:info@example.com">INFO@aya.COM
</a>
</li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>09851654725</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Syria <span>Hotel</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4 style="color: red">Syria Hotel</h4>
...
<a href="rt/rs.php"><h2 >Rate Us</h2></a>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>0988582010</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">aya@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Lattakia </p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d43678.757227252914!2d35.80003987336858!3d35.54275858914645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sar!2s!4v1557126608702!5m2!1sar!2s" width="1350" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 Syria Hotel . All Rights Reserved | Design by <a href="index.php">aya - marah</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
...
<script type="text/javascript">
  ...
  $('#WAButton').floatingWhatsApp({
    phone: '00963 991 513 912', //WhatsApp Business phone number International format-
